...
function PlaceCarditem({ place }) {
    ...
    return (
        <div>
            <Link to={'https://www.google.com/maps/search/?api=1&query=' + place?.place_name + "," + place?.geo_coordinates} target='_blank'>
                <div className='my-4 bg-gray-50 p-2 gap-2 border rounded-lg flex flex-cols-2 hover:scale-105 transition-all hover:shadow-md cursor-pointer '>
                    ...
                    <div>
                    <h2 className='font-medium text-sm text-orange-600'>{place.time_travel}</h2>
